...
%changelog
* Mon Jul 27 2026 Vincent Michel <vincent.michel@vates.tech> - 1:3.5.5-1.3
...
- Remove backported patches as OpenSSL 3.0.9 is not affected by the CVEs they
  were fixing: openssl-1.0.2k-cve-2019-1547.backport.patch,
  openssl-1.0.2k-cve-2019-1551.backport.patch, and
  openssl-1.0.2k-cve-2019-1563.backport.patch
- Remove a patch fixing a build time test as it's no longer necessary on 3.0.9:
  openssl-1.0.2k-update-expiring-certificates.patch
- *** Upstream changelog ***
...
* Fri Dec  4 2020 Sahana Prasad <sahana@redhat.com> 1.0.2k-20
